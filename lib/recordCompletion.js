...
export async function recordCompletion(supabase, taskId, staffId, currentPharmacyId) {
...
export async function undoCompletion(supabase, taskId, currentPharmacyId) {
